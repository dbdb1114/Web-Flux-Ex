...
public class StockController {
    ...
    public Mono<AbstractStock> decreaseStock(@RequestBody RequestStock requestStock){
    ...
    public Mono<AbstractStock> increaseStock(@RequestBody RequestStock requestStock){
